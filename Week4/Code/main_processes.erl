...
-export([init/1, pick_name/0,firstnames/0,
  lastnames/0, handle_call/3, handle_cast/2,
...
terminate(bad_note, S) ->
  io:format("~s sucks! kick that member out of the band! (~s) ~n",
